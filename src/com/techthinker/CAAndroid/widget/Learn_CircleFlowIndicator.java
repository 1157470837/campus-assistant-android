...
public class Learn_CircleFlowIndicator extends View implements Learn_FlowIndicator,
		AnimationListener {
	...
	private Learn_ViewFlow viewFlow;
	 ...
	 * @param context
	 */
	public Learn_CircleFlowIndicator(Context context) {
		super(context);
	 ...
	 * @param attrs
	 */
	public Learn_CircleFlowIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);

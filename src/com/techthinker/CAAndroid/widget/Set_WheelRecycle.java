...
public class Set_WheelRecycle {
	...
	// Wheel view
	private Set_WheelView wheel;
	
	/**
	 * Constructor
	 * @param wheel the wheel view
	 */
	public Set_WheelRecycle(Set_WheelView wheel) {
		this.wheel = wheel;
	}
	 ...
	 */
	public int recycleItems(LinearLayout layout, int firstItem, Set_ItemsRange range) {
		int index = firstItem;

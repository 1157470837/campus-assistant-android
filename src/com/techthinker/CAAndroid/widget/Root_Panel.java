...
public class Root_Panel extends LinearLayout {
	...
	public Root_Panel(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//			Log.d(TAG, "state: " + mState + " x: " + event.getX() + " y: " + event.getY());
	...
	private void postProcess() {
		...
		if (panelListener != null) {
			if (mIsShrinking) {
				panelListener.onPanelClosed(Root_Panel.this);
			} else {
				panelListener.onPanelOpened(Root_Panel.this);
			}
		}
	}

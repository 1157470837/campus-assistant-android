...
public class Learn_ViewFlow extends AdapterView<Adapter> {
	...
	private Learn_FlowIndicator mIndicator;
	...
	public Learn_ViewFlow(Context context) {
		super(context);
		mSideBuffer = 3;
		init();
	}

	public Learn_ViewFlow(Context context, int sideBuffer) {
		super(context);
		mSideBuffer = sideBuffer;
		init();
	}

	public Learn_ViewFlow(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * @param flowIndicator
	 */
	public void setFlowIndicator(Learn_FlowIndicator flowIndicator) {
